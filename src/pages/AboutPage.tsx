        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg">
              <img 
                src="https://images.pexels.com/photos/4046567/pexels-photo-4046567.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" 
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-600 mb-6">
                MedicoMeet was founded in 2023 by a team of healthcare professionals and technology experts who recognized the challenges patients face when trying to access quality healthcare services.
              </p>
              <p className="text-gray-600 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  A renowned cardiologist with over 15 years of experience in healthcare, Dr. Johnson founded MedicoMeet to address the challenges she observed in patient care.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  A pediatrician with a passion for accessible healthcare, Dr. Rodriguez ensures that our platform maintains high standards of medical quality and ethics.
                </p>
              </div>
            </div>
          </div>
